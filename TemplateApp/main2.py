...
#
#             self.description_label1 = tk.Label(self.frm0, text="Description", width=20)
...
#             main_button.grid(column=0, row=1,sticky='w',padx=30)
...
#             minus_button.grid(column=0, row=1,sticky='e', padx=30)
#
...
#
#
#             self.description_label0 = tk.Label(self.frm5, text="Important Information",width=20)
...
#                            sticky="nswe")  # adapt to window
#
#             self.label1 = tk.Label(self.frm1,text="Features & Benefits", width=20)
...
#                                sticky="nswe")  # adapt to window
#
#             self.label1 = tk.Label(self.frm2, text="Specifications",width=20)
...
#                                sticky="nswe")  # adapt to window
#
#             self.label1 = tk.Label(self.frm4, text="What is Included?", width=20)
#             self.label1.grid(column=1, row=0,sticky='nswe')
#             self.label1.config(font=("Roboto", 12,'bold','underline'))
...
#             self.important_entry = Text(self.frm5,width=20,height = 5)
...
#             global description_paragraph_count
#             global description_paragraphs
#             if (description_paragraph_count >= 8):
#                 return
#             description_paragraph_count += 1
...
#             self.description_entry = Text(self.frm0, width=20, height=5)
#
...
#             self.feature_entry = Entry(self.frm1,width=30)
...
#             self.item_entry = Entry(self.frm4,width=30)
